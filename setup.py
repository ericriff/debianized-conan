...
# pylint: disable=
# mkvenv: no-deps
""" Debian packaging for the conan package.

    | Copyright ©  2022, Eric Riff
    | See LICENSE for details.

    This puts the ``conan`` Python package and its dependencies as released
    ...
    .. _`GitHub README`: https://github.com/ericriff/debianized-conan
"""
import io
import os
import re
...
project = dict(
    ...
    keywords='conan deployment debian-packages dh-virtualenv devops omnibus-packages'.split(),
    install_requires=[
        # core
        'conan==' + upstream_version,
